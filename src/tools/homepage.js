...
const T = {
  en: {
    ...
    seoP1: 'DateCalc.app is a free collection of date and time calculators covering every common calculation you might need. Whether you want to know exactly how old you are to the second, count the days between two dates, find out how many business days remain before a deadline, or convert a time across time zones — this site has a dedicated tool for it. All calculators run directly in your browser with no account required and no paywalls. The site is supported by Google AdSense, which keeps it free for everyone. The results are instant and the interface is clean, so you spend time on your task — not on the tool.',
    seoH2b: 'Why use a dedicated date calculator?',
    seoP2: 'Mental date arithmetic is error-prone: month lengths vary, leap years add a day every four years, and time zones shift the calendar date entirely. A dedicated calculator eliminates guesswork. Professionals use them for legal deadlines, contract durations, project timelines, and compliance windows. Parents use baby-age calculators to track developmental milestones. Pet owners compare their animals\' ages in human terms. And everyone counts down to the holidays. DateCalc.app covers all these use cases across 10 languages, making it a globally accessible resource for anyone who works with dates.',
    faqs: [
      ...
      { q: 'What languages are supported?', a: 'DateCalc.app is available in 10 languages: English, French, Spanish, Portuguese, German, Italian, Polish, Japanese, Korean, and Dutch. Every tool is fully translated and uses locale-appropriate date formats. Switch languages using the language selector at the top of any page.' },
    ],
  },
  fr: {
    ...
    faqs: [
      ...
      { q: 'Quelles langues sont prises en charge ?', a: 'DateCalc.app est disponible en 10 langues : anglais, français, espagnol, portugais, allemand, italien, polonais, japonais, coréen et néerlandais. Chaque outil est entièrement traduit et utilise des formats de date adaptés à chaque langue. Changez de langue en utilisant le sélecteur en haut de chaque page.' },
    ],
  },
  es: {
    ...
    faqs: [
      ...
      { q: '¿Qué idiomas están disponibles?', a: 'DateCalc.app está disponible en 10 idiomas: inglés, francés, español, portugués, alemán, italiano, polaco, japonés, coreano y neerlandés. Cada herramienta está completamente traducida y usa formatos de fecha apropiados para cada idioma. Cambia de idioma usando el selector en la parte superior de cualquier página.' },
    ],
  },
  pt: {
