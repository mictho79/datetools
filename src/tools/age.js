...
module.exports = {
  pages: [
    {
      id: 'age-calculator',
      slugs: { en: 'age-calculator', fr: 'fr/calculateur-age', es: 'es/calculadora-edad', pt: 'pt/calculadora-de-idade', de: 'de/altersrechner', it: 'it/calcolo-eta', pl: 'pl/kalkulator-wieku' },
    },
  ],
