...
module.exports = {
  pages: [
    { id: 'new-year',  slugs: { en: 'days-until-new-year',  fr: 'fr/jours-avant-nouvel-an', es: 'es/dias-para-ano-nuevo', pt: 'pt/dias-para-ano-novo' } },
    { id: 'halloween', slugs: { en: 'days-until-halloween',  fr: 'fr/jours-avant-halloween',  es: 'es/dias-para-halloween',  pt: 'pt/dias-para-o-halloween' } },
    { id: 'easter',    slugs: { en: 'days-until-easter',     fr: 'fr/jours-avant-paques',     es: 'es/dias-para-pascua',    pt: 'pt/dias-para-a-pascoa'   } },
  ],
  render(pageId, lang) {
