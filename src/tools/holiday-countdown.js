...
const HOLIDAYS = {
  'new-year': {
    ...
    es: {
      ...
      seoP1: 'El Día de Año Nuevo es siempre el 1 de enero. La cuenta regresiva de arriba se actualiza en tiempo real y muestra los días, horas, minutos y segundos que faltan hasta la medianoche del 1 de enero, el momento de las campanadas. Cuando el año ya ha empezado, el contador salta automáticamente al 1 de enero siguiente.',
      seoH2b: 'Las campanadas y las 12 uvas de la suerte',
      seoP2: 'En España, la tradición más conocida es comer doce uvas, una con cada una de las doce campanadas que marcan la medianoche desde la Puerta del Sol de Madrid. Según la costumbre, quien consigue comerlas todas a tiempo tendrá un año de buena suerte. La tradición se popularizó a principios del siglo XX y hoy se sigue en directo por televisión en gran parte del mundo hispanohablante.',
      seoH2c: 'Tradiciones de Año Nuevo en Latinoamérica',
      seoP3: 'Cada país tiene sus propios rituales para atraer la suerte. En muchos lugares se viste ropa interior amarilla o roja (para la prosperidad o el amor), se sale a la calle con una maleta para asegurar viajes durante el año, o se comen lentejas para la abundancia. En Ecuador, Colombia y otros países se quema el «año viejo», un muñeco que simboliza dejar atrás lo malo del año que termina. El brindis suele hacerse con cava, sidra o champán.',
      faqTitle: 'Preguntas frecuentes',
      faqs: [
        { q: '¿Cuántos días faltan para Año Nuevo 2027?', a: 'La cuenta regresiva de arriba muestra el número exacto de días hasta el 1 de enero de 2027, actualizado al segundo.' },
        { q: '¿Por qué se comen 12 uvas en Nochevieja?', a: 'Se come una uva con cada una de las doce campanadas de la medianoche. Es una tradición española que simboliza desear suerte para cada uno de los doce meses del nuevo año.' },
        { q: '¿A qué hora son las campanadas?', a: 'A medianoche (00:00) del 1 de enero, hora local. En España se retransmiten en directo desde el reloj de la Puerta del Sol de Madrid.' },
        { q: '¿El Año Nuevo es el mismo día en todo el mundo?', a: 'El Año Nuevo del calendario gregoriano es el 1 de enero, pero otras culturas lo celebran en fechas distintas: el Año Nuevo chino, por ejemplo, cae entre el 21 de enero y el 20 de febrero.' },
        { q: '¿Qué día de la semana cae el 1 de enero de 2027?', a: 'El 1 de enero de 2027 es viernes. El contador de arriba indica siempre el día del próximo Año Nuevo.' },
      ],
  ...
  'halloween': {
    ...
    es: {
      ...
      seoP1: 'Halloween se celebra cada año la noche del 31 de octubre, la víspera del Día de Todos los Santos. La cuenta regresiva de arriba se actualiza en tiempo real y apunta a la medianoche del 31 de octubre; cuando esa fecha ya ha pasado, salta automáticamente al año siguiente. En 2026, el 31 de octubre cae en sábado.',
      seoH2b: 'Origen e historia de Halloween',
      seoP2: 'El nombre proviene de «All Hallows’ Eve» (víspera de Todos los Santos) y sus raíces se remontan al Samaín (Samhain), el antiguo festival celta que marcaba el fin de la cosecha y el inicio del invierno, cuando se creía que el velo entre los vivos y los muertos se adelgazaba. Con la emigración irlandesa en el siglo XIX, la fiesta llegó a Estados Unidos, donde adoptó los disfraces, el «truco o trato» y las calabazas talladas (jack-o’-lantern) que hoy la caracterizan.',
      seoH2c: 'Halloween, Día de Todos los Santos y Día de Muertos',
      seoP3: 'En los países hispanohablantes, Halloween convive con festividades propias y no debe confundirse con ellas. En España, el 1 de noviembre es el Día de Todos los Santos, jornada para visitar los cementerios y recordar a los difuntos. En México, el 1 y 2 de noviembre se celebra el Día de Muertos, con altares u ofrendas, flores de cempasúchil y calaveras de azúcar; es una tradición de raíces prehispánicas reconocida por la UNESCO, con un significado distinto al del Halloween anglosajón, aunque a veces se mezclen en la cultura popular.',
      faqTitle: 'Preguntas frecuentes',
      faqs: [
        { q: '¿Cuántos días faltan para Halloween 2026?', a: 'La cuenta regresiva de arriba muestra el número exacto de días hasta el 31 de octubre de 2026, actualizado al segundo.' },
        { q: '¿Qué día de la semana es Halloween 2026?', a: 'Halloween 2026 (31 de octubre) cae en sábado.' },
        { q: '¿Halloween y el Día de Muertos son lo mismo?', a: 'No. Halloween (31 de octubre) tiene origen celta y anglosajón, mientras que el Día de Muertos mexicano (1 y 2 de noviembre) honra a los difuntos con altares y tiene raíces prehispánicas. Caen en fechas cercanas, pero son celebraciones diferentes.' },
        { q: '¿Por qué Halloween es el 31 de octubre?', a: 'Porque es la víspera del Día de Todos los Santos (1 de noviembre); de ahí su nombre en inglés, «All Hallows’ Eve».' },
        { q: '¿Se celebra Halloween en España y América Latina?', a: 'Cada vez más, sobre todo entre los jóvenes y los niños, aunque convive con el Día de Todos los Santos y, en México, con el Día de Muertos.' },
      ],
      weekDays: ['Domingo','Lunes','Martes','Miércoles','Jueves','Viernes','Sábado'],
      months: ['enero','febrero','marzo','abril','mayo','junio','julio','agosto','septiembre','octubre','noviembre','diciembre'],
    },
  ...
  'easter': {
    ...
    es: {
      ...
      seoP1: 'El Domingo de Pascua o Domingo de Resurrección cae el primer domingo después de la primera luna llena que sigue al equinoccio de primavera (21 de marzo). Por eso es una fiesta «móvil»: puede caer entre el 22 de marzo y el 25 de abril, y cambia de fecha cada año. La cuenta regresiva de arriba calcula automáticamente el próximo Domingo de Pascua.',
      seoH2b: '¿Cómo se calcula la fecha de Pascua?',
      seoP2: 'La fecha de Pascua se rige por reglas eclesiásticas establecidas en el año 325 d. C. en el Concilio de Nicea. El cálculo utiliza una luna llena «eclesiástica» fija (una tabla litúrgica) en lugar de la luna llena astronómica real, por lo que a veces la fecha no coincide exactamente con la luna llena del cielo.',
      seoH2c: 'La Semana Santa en España y Latinoamérica',
      seoP3: 'El Domingo de Pascua cierra la Semana Santa, que comienza el Domingo de Ramos e incluye el Jueves y el Viernes Santo. En España es una de las celebraciones más importantes del año, con procesiones de cofradías especialmente célebres en Andalucía (Sevilla, Málaga) y en Castilla. En Latinoamérica, países como México, Guatemala, Perú y Colombia viven también una Semana Santa intensa, con procesiones, alfombras de aserrín y una gastronomía propia de estas fechas.',
      faqTitle: 'Preguntas frecuentes',
      faqs: [
        { q: '¿Cuándo es Pascua 2026?', a: 'El Domingo de Pascua de 2026 cae el 5 de abril de 2026.' },
        { q: '¿Cuándo es Pascua 2027?', a: 'El Domingo de Pascua de 2027 cae el 28 de marzo de 2027.' },
        { q: '¿Por qué la Pascua cambia de fecha cada año?', a: 'Porque es una fiesta móvil vinculada al calendario lunar: cae el primer domingo después de la primera luna llena eclesiástica posterior al 21 de marzo.' },
        { q: '¿Qué diferencia hay entre Pascua y Semana Santa?', a: 'La Semana Santa es la semana que va del Domingo de Ramos al Sábado Santo; el Domingo de Pascua (o de Resurrección) es el día siguiente, que culmina y cierra esa semana.' },
        { q: '¿La Pascua ortodoxa cae el mismo día?', a: 'No. La Pascua ortodoxa se calcula con el calendario juliano, por lo que suele caer en una fecha distinta, normalmente entre 1 y 5 semanas después de la Pascua occidental.' },
      ],
      weekDays: ['Domingo','Lunes','Martes','Miércoles','Jueves','Viernes','Sábado'],
      months: ['enero','febrero','marzo','abril','mayo','junio','julio','agosto','septiembre','octubre','noviembre','diciembre'],
    },
