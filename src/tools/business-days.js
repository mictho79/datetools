...
module.exports = {
  pages: [
    { id: 'business-days-calculator', slugs: { en: 'business-days-calculator', fr: 'fr/calculateur-jours-ouvrables', es: 'es/calculadora-dias-habiles', pt: 'pt/calculadora-dias-uteis', de: 'de/arbeitstage-rechner', it: 'it/calcolatore-giorni-lavorativi', pl: 'pl/kalkulator-dni-roboczych' } },
  ],
