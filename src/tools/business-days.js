...
module.exports = {
  pages: [
    { id: 'business-days-calculator', slugs: { en: 'business-days-calculator', fr: 'fr/calculateur-jours-ouvrables', es: 'es/calculadora-dias-habiles', pt: 'pt/calculadora-dias-uteis' } },
  ],
