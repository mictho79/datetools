...
const BIO = {
  ...
  de: {
    ...
    bio: '<p>Mike ist der Entwickler hinter DateCalc.app. Wohnhaft in Frankreich, besessen von Zeitzonen, Grenzfällen bei Datumsberechnungen und der Idee, dass die Tools in 10 Sprachen genau gleich funktionieren müssen. Hat feste Meinungen dazu, ob Wochen am Sonntag oder Montag beginnen (Antwort: Montag, ISO 8601, Ende der Debatte), zu welchem Datum ein Tag "gehört" (Mitternacht UTC? lokale Mitternacht? das Telefon des Nutzers?) und ob Schaltsekunden einen eigenen Rechner verdienen (noch nicht).</p><p>Davor hat er Tools im Enterprise-ERP-Bereich und ein paar Consumer-Apps abgeliefert, über die niemand mehr spricht. DateCalc ist das Projekt, das er abends immer weiter geschrieben hat, bis es kein Nebenprojekt mehr war. Es ist immer noch ein Ein-Personen-Betrieb: Alles, was du siehst — der Text in 10 Sprachen, die Grenzfälle, die Typografie-Entscheidungen — ist Mike.</p><p>Bug gefunden, schlechte Übersetzung, einen Grenzfall übersehen? <a href="mailto:hello@datecalc.app">hello@datecalc.app</a>.</p>',
