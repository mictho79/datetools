...
const I18N = {
  ...
  event: {
    ...
    ja: {
      ...
      kicker: '年ごとの歴史',
      h1: '年代別の出来事 — 年ごとの歴史',
      intro: '<p>歴史は一年ずつ見るほうが把握しやすいものです。抽象的な日付はあまり意味を持ちませんが、曲のリリース、政治的な転機、あるいは新技術の登場と結びついた日付は拠り所となります。このハブは、1905年から2025年までの近代史を一年単位で扱う121の単年ページへの入り口です。</p><p>各年のページには、その年を特徴づけた出来事が集約されています — 世界情勢、発見、スポーツ、そして人々がリアルタイムで消費した文化です。祖父母が結婚した年、卒業した年、先祖が海を渡った年に何が起きたのかを知りたいなら、ここから始めてください。ハブは索引として機能し、個別ページが物語を運びます。</p><p>下の年代別リストを参照してください：1900年代、1910年代、1920年代、そして2020年代まで。各年代の中で各年は直接リンクとして表示されます。この資料を当サイトの<a href="/ja/nenrei-keisanki/">年齢計算機</a>や<a href="/ja/umare-doshi/">生まれ年インデックス</a>と組み合わせれば、伝記や同窓会のプログラムを並べたり、ある特定の年が世紀全体の中でどのように位置づけられるかを理解したりできます。</p>',
      pickDecade: '年代を選択',
