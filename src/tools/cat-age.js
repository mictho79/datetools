...
module.exports = {
  pages: [
    { id: 'cat-age-calculator', slugs: { en: 'cat-age-calculator', fr: 'fr/calculateur-age-chat', es: 'es/calculadora-edad-gato', pt: 'pt/calculadora-idade-gato', de: 'de/katze-alter-rechner', it: 'it/calcolatore-eta-gatto', pl: 'pl/wiek-kota' } },
  ],
