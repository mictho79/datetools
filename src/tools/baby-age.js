...
const T = {
  en: {
    ...
    seoH2b: 'What is corrected age for premature babies?',
  ...
  fr: {
    ...
    seoH2b: 'Qu\'est-ce que l\'âge corrigé pour les bébés prématurés ?',
  ...
  es: {
    ...
    seoH2b: '¿Qué es la edad corregida para bebés prematuros?',
