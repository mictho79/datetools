...
const T = {
  ...
  ja: {
    title: 'カウントダウン – 任意の日付までのカウントダウン | DateCalc.app',
    metaDesc: '無料のオンラインカウントダウンタイマー。任意の未来の日付を入力して、日・時間・分・秒のリアルタイムカウントダウンを取得します。',
    kicker: 'カウントダウン',
    headline: '任意の<em>日付</em>まで<br>カウントダウン',
    subhead: '目標日を入力して、リアルタイムでカウントダウンを見ましょう。',
    targetLabel: '目標日',
    labelLabel: 'イベント名（任意）',
    calcBtn: '→ カウントダウン開始',
    tipText: '"待つことは喜びの一部です。"',
    examples: ['大晦日', '次の誕生日', 'プロジェクトの締め切り'],
    resultsHeader: 'カウントダウン',
    heroSuffix: '日',
    hoursLbl: '時間', minsLbl: '分', secsLbl: '秒',
    weeksLbl: '週', totalHoursLbl: '合計時間', totalMinsLbl: '合計分',
    eventLbl: 'イベント', dateLbl: '目標日', dayLbl: '曜日',
    errInvalid: '→ 無効な日付です。入力を確認してください。',
    errPast: '→ 目標日は未来の日付にしてください。',
    reachedMsg: 'このイベントはすでに過ぎました。',
    seoH2a: 'カウントダウンタイマーの使い方は？',
    seoP1: '任意の未来の日付を入力して「カウントダウン開始」をクリックしてください。タイマーはその日付の真夜中まで残り日数・時間・分・秒を即座に表示し、ページを更新せずに毎秒リアルタイムで更新されます。イベント名（「私の結婚式」や「パリ旅行」など）を追加してカウントダウンをパーソナライズすることもできます。',
    seoH2b: 'カウントダウンタイマーの一般的な用途',
    seoP2: 'カウントダウンタイマーは多くの実用的な目的に使われます。個人的な節目：誕生日まで何日、クリスマスまで何日、結婚式までのカウントダウン、夏休みまでの日数。学業・仕事：試験まで何日、プロジェクト締め切りまでのカウントダウン、卒業まで何日。旅行・イベント：フライトまで何日、スポーツ大会やフェスティバルのカウントダウン。',
    faqTitle: 'よくある質問',
    source: { url: 'https://en.wikipedia.org/wiki/Countdown', label: 'Wikipedia – カウントダウン' },
    faqs: [
      { q: '無料のオンラインカウントダウンタイマーの使い方は？', a: '目標日（日・月・年）を上のフィールドに入力し、イベント名を任意で入力して「カウントダウン開始」をクリックしてください。タイマーは残り日数・時間・分・秒を即座に表示し、毎秒更新されます。' },
      { q: '誕生日まで何日ありますか？', a: '上に次の誕生日を入力して「カウントダウン開始」をクリックしてください。タイマーは誕生日の真夜中まで正確な日数・時間・分・秒を表示します。' },
      { q: '結婚式のカウントダウンを作るには？', a: '目標日のフィールドに結婚式の日付を入力し、イベント名フィールドに「私たちの結婚式」などを入力して「カウントダウン開始」をクリックしてください。' },
      { q: '休暇まで何日ありますか？', a: '休暇の出発日を目標として入力し、名前を付けてカウントダウンを開始してください。残り日数と週・時間・分の内訳の両方が表示されます。' },
      { q: '卒業式まで何日ですか？', a: '卒業式の日付を入力し、「卒業式の日」と名前を付けて「カウントダウン開始」をクリックしてください。リアルタイムカウントダウンが毎秒更新されます。' },
      { q: '特定の日付まで何日ですか？', a: '任意の未来の日付を上の計算ツールに入力するだけで、タイマーは残り日数を即座に表示します。2099年12月31日まで対応しています。' },
      { q: 'カウントダウンはリアルタイムで更新されますか？', a: 'はい。秒・分・時間は毎秒自動的に更新されます。ページの更新は不要です。' },
      { q: '対応している最大の日付は何ですか？', a: '計算ツールは2099年12月31日まで対応しており、最大73年以上のカウントダウンが可能です。' },
    ],
    weekDays: ['日曜日','月曜日','火曜日','水曜日','木曜日','金曜日','土曜日'],
    months: ['1月','2月','3月','4月','5月','6月','7月','8月','9月','10月','11月','12月'],
  },
  ko: {
    title: '카운트다운 – 임의 날짜까지 카운트다운 | DateCalc.app',
    metaDesc: '무료 온라인 카운트다운 타이머. 임의의 미래 날짜를 입력하고 일, 시간, 분, 초의 실시간 카운트다운을 받으세요.',
    kicker: '카운트다운',
    headline: '임의의 <em>날짜</em>까지<br>카운트다운',
    subhead: '목표 날짜를 입력하고 실시간으로 카운트다운을 지켜보세요.',
    targetLabel: '목표 날짜',
    labelLabel: '이벤트 이름 (선택사항)',
    calcBtn: '→ 카운트다운 시작',
    tipText: '"기다리는 것은 기쁨의 일부입니다."',
    examples: ['새해 전날', '다음 생일', '프로젝트 마감'],
    resultsHeader: '카운트다운',
    heroSuffix: '일',
    hoursLbl: '시간', minsLbl: '분', secsLbl: '초',
    weeksLbl: '주', totalHoursLbl: '총 시간', totalMinsLbl: '총 분',
    eventLbl: '이벤트', dateLbl: '목표 날짜', dayLbl: '요일',
    errInvalid: '→ 유효하지 않은 날짜입니다. 입력을 확인하세요.',
    errPast: '→ 목표 날짜는 미래여야 합니다.',
    reachedMsg: '이 이벤트는 이미 지났습니다.',
    seoH2a: '카운트다운 타이머 사용 방법은?',
    seoP1: '임의의 미래 날짜를 입력하고 "카운트다운 시작"을 클릭하세요. 타이머는 해당 날짜의 자정까지 남은 일수, 시간, 분, 초를 즉시 표시하고 페이지를 새로고침하지 않고 매초 실시간으로 업데이트됩니다.',
    seoH2b: '카운트다운 타이머의 일반적인 용도',
    seoP2: '카운트다운 타이머는 많은 실용적인 목적으로 사용됩니다. 개인 이정표: 생일까지 며칠, 크리스마스까지 며칠, 결혼식 카운트다운, 여름 방학까지의 일수. 학업/직업: 시험까지 며칠, 프로젝트 마감 카운트다운, 졸업까지 며칠. 여행/이벤트: 비행기까지 며칠, 스포츠 대회 카운트다운.',
    faqTitle: '자주 묻는 질문',
    source: { url: 'https://en.wikipedia.org/wiki/Countdown', label: 'Wikipedia – 카운트다운' },
    faqs: [
      { q: '무료 온라인 카운트다운 타이머 사용 방법은?', a: '위의 필드에 목표 날짜(일, 월, 년)를 입력하고, 선택적으로 이벤트 이름을 입력한 다음 "카운트다운 시작"을 클릭하세요. 타이머는 남은 일수, 시간, 분, 초를 즉시 표시하고 매초 업데이트됩니다.' },
      { q: '생일까지 며칠 남았나요?', a: '위에 다음 생일을 입력하고 카운트다운 시작을 클릭하세요. 타이머는 생일 자정까지 정확한 일수, 시간, 분, 초를 표시합니다.' },
      { q: '결혼식 카운트다운을 만들려면?', a: '목표 날짜 필드에 결혼식 날짜를 입력하고, 이벤트 이름 필드에 "우리의 결혼식" 또는 원하는 이름을 입력한 다음 카운트다운 시작을 클릭하세요.' },
      { q: '휴가까지 며칠 남았나요?', a: '휴가 출발일을 목표로 입력하고 이름을 지정한 후 카운트다운을 시작하세요. 남은 총 일수와 주, 시간, 분의 분류가 모두 표시됩니다.' },
      { q: '졸업까지 며칠인가요?', a: '졸업식 날짜를 입력하고 "졸업의 날"이라고 이름 붙인 후 카운트다운 시작을 클릭하세요. 실시간 카운트다운이 매초 업데이트됩니다.' },
      { q: '특정 날짜까지 며칠인가요?', a: '위의 계산기에 임의의 미래 날짜를 입력하기만 하면 타이머가 남은 정확한 일수를 즉시 표시합니다. 2099년 12월 31일까지 지원됩니다.' },
      { q: '카운트다운이 실시간으로 업데이트되나요?', a: '네. 초, 분, 시간이 매초 자동으로 업데이트됩니다. 페이지를 새로고침할 필요가 없습니다.' },
      { q: '지원되는 최대 날짜는 무엇인가요?', a: '계산기는 2099년 12월 31일까지 지원하며, 최대 73년 이상의 카운트다운이 가능합니다.' },
    ],
    weekDays: ['일요일','월요일','화요일','수요일','목요일','금요일','토요일'],
    months: ['1월','2월','3월','4월','5월','6월','7월','8월','9월','10월','11월','12월'],
  },
  nl: {
    title: 'Aftellen – Tel af naar Elke Datum | DateCalc.app',
    metaDesc: 'Gratis online afteltimer. Voer een toekomstige datum in en krijg een live aftelling in dagen, uren, minuten en seconden.',
    kicker: 'Aftellen',
    headline: 'Aftellen naar<br>een willekeurige <em>datum</em>',
    subhead: 'Voer een doeldatum in — bekijk het live aftellen in realtime.',
    targetLabel: 'Doeldatum',
    labelLabel: 'Evenementnaam (optioneel)',
    calcBtn: '→ Start aftellen',
    tipText: '"Wachten is een deel van de vreugde."',
    examples: ['Oudejaarsavond', 'Volgende verjaardag', 'Projectdeadline'],
    resultsHeader: 'Aftelling',
    heroSuffix: 'dagen',
    hoursLbl: 'uren', minsLbl: 'minuten', secsLbl: 'seconden',
    weeksLbl: 'weken', totalHoursLbl: 'totale uren', totalMinsLbl: 'totale minuten',
    eventLbl: 'Evenement', dateLbl: 'Doeldatum', dayLbl: 'Dag van de week',
    errInvalid: '→ Ongeldige datum. Controleer je invoer.',
    errPast: '→ De doeldatum moet in de toekomst liggen.',
    reachedMsg: 'Dit evenement is al verstreken.',
    seoH2a: 'Hoe gebruik je een afteltimer?',
    seoP1: 'Voer een toekomstige datum in en klik op "Start aftellen". De timer toont direct het exacte aantal resterende dagen, uren, minuten en seconden tot middernacht op die datum, en wordt elke seconde live bijgewerkt zonder de pagina te vernieuwen. Je kunt ook een evenementnaam toevoegen — zoals "Mijn bruiloft" of "Reis naar Parijs" — om de aftelling te personaliseren.',
    seoH2b: 'Veelvoorkomende toepassingen van afteltimers',
    seoP2: 'Afteltimers dienen veel praktische doeleinden. Persoonlijke mijlpalen: hoeveel dagen tot mijn verjaardag, hoeveel dagen tot Kerstmis, aftellen tot mijn bruiloft, dagen tot de zomervakantie. Academisch en professioneel: dagen tot het examen, aftellen tot de projectdeadline, dagen tot de diploma-uitreiking. Reizen en evenementen: dagen tot de vlucht, aftellen tot een sportkampioenschap, festival of concert.',
    faqTitle: 'Veelgestelde vragen',
    source: { url: 'https://en.wikipedia.org/wiki/Countdown', label: 'Wikipedia – Aftellen' },
    faqs: [
      { q: 'Hoe gebruik je een gratis online afteltimer?', a: 'Voer je doeldatum (dag, maand, jaar) in de velden hierboven in, voer optioneel een evenementnaam in en klik op "Start aftellen". De timer toont direct de exacte resterende dagen, uren, minuten en seconden, en wordt elke seconde bijgewerkt. Werkt op elk apparaat zonder app of account.' },
      { q: 'Hoeveel dagen tot mijn verjaardag?', a: 'Voer de datum van je volgende verjaardag hierboven in en klik op Start aftellen. De timer toont het exacte aantal dagen, uren, minuten en seconden tot middernacht op je verjaardag.' },
      { q: 'Hoe maak ik een aftelling voor een bruiloft?', a: 'Voer de bruiloftsdatum in de doeldatumvelden in, voer "Onze Bruiloft" of een andere aangepaste naam in het evenementnaamveld in en klik op Start aftellen.' },
      { q: 'Hoeveel dagen tot mijn vakantie?', a: 'Voer de vertrekdatum van je vakantie als doel in, geef het een naam en start de aftelling. De calculator toont zowel het totale resterende aantal dagen als de uitsplitsing in weken, uren en minuten.' },
      { q: 'Hoe tel ik af tot de diploma-uitreiking?', a: 'Voer de datum van de diploma-uitreiking in, noem het "Diploma-uitreikingsdag" en klik op Start aftellen. De live aftelling wordt seconde voor seconde bijgewerkt.' },
      { q: 'Hoeveel dagen tot een bepaalde datum?', a: 'Voer gewoon een toekomstige datum in de calculator hierboven in en de timer toont direct het exacte resterende aantal dagen. Datums tot 31 december 2099 worden ondersteund.' },
      { q: 'Wordt de aftelling in realtime bijgewerkt?', a: 'Ja. Seconden, minuten en uren worden elke seconde automatisch bijgewerkt. Je hoeft de pagina niet te vernieuwen.' },
      { q: 'Wat is de maximaal ondersteunde datum?', a: 'De calculator ondersteunt datums tot 31 december 2099, wat een maximale aftelling van meer dan 73 jaar geeft.' },
    ],
...
module.exports = {
  pages: [
    { id: 'countdown-timer', slugs: { en: 'countdown-timer', fr: 'fr/compte-a-rebours', es: 'es/cuenta-regresiva', pt: 'pt/temporizador-regressivo', de: 'de/countdown-timer', it: 'it/conto-alla-rovescia', pl: 'pl/odliczanie', ja: 'ja/kauntodaun', ko: 'ko/kaunteu-daun', nl: 'nl/aftellen' } },
  ],
