...
const T = {
  ...
  ja: {
    titleTpl: '{year}年の週番号 – ISO週カレンダー完全版',
    metaDescTpl: '{year}年のISO週番号の完全なリスト。全{weeks}週の開始日と終了日付き。無料ISOカレンダー。',
    kicker: '週カレンダー',
    headlineTpl: '週番号<br><em>{year}年</em>',
    subheadTpl: '{year}年の全{weeks}ISO週 — 各週の開始日と終了日付き。',
    weekLabel: '週',
    fromLabel: '開始（月曜）',
    toLabel: '終了（日曜）',
    ...
    currentWeekLabel: '今週',
    totalWeeksLabel: 'ISO週の合計',
    weeksInYear: '週',
    seoH2a: 'ISO週番号とは？',
    seoP1: 'ISO 8601の週番号は、各年の週を1から52（または53）に番号付けするシステムです。週は月曜日に始まり、その年の最初の木曜日を含む週が第1週となります。',
    seoH2b: '{year}年の週番号の使い方',
    seoP2Tpl: 'この週カレンダーはプロジェクト計画、締め切りの確認、会計四半期の計算、または番号付き週が必要なあらゆる場面でご活用ください。',
    faqTitle: 'よくある質問',
    source: null,
    faqsTpl: [
      { q: '{year}年は何週ありますか？', a: '{year}年はISO 8601カレンダーによると{weeks}週あります。' },
      { q: '{year}年の第1週はいつ始まりますか？', a: '{year}年の第1週は{w1startFull}に始まります。' },
    ],
  },
  ko: {
    titleTpl: '{year}년 주 번호 – ISO 주 달력 완전판',
    metaDescTpl: '{year}년 ISO 주 번호 전체 목록. 전체 {weeks}주의 시작일과 종료일 포함. 무료 ISO 달력.',
    kicker: '주 달력',
    headlineTpl: '주 번호<br><em>{year}년</em>',
    subheadTpl: '{year}년의 모든 {weeks}개 ISO 주 — 각 주의 시작일과 종료일 포함.',
    weekLabel: '주',
    fromLabel: '시작 (월요일)',
    toLabel: '종료 (일요일)',
    ...
    totalWeeksLabel: 'ISO 주 합계',
    weeksInYear: '주',
    seoH2a: 'ISO 주 번호란?',
    seoP1: 'ISO 8601 주 번호는 각 연도의 주를 1부터 52(또는 53)까지 번호를 매기는 시스템입니다. 주는 월요일에 시작하며, 해당 연도의 첫 번째 목요일을 포함하는 주가 제1주입니다.',
    seoH2b: '{year}년 주 번호 사용 방법',
    seoP2Tpl: '이 주 달력을 프로젝트 계획, 마감일 확인, 회계 분기 계산 또는 번호가 매겨진 주가 필요한 모든 상황에 활용하세요.',
    faqTitle: '자주 묻는 질문',
    source: null,
    faqsTpl: [
      { q: '{year}년에는 몇 주가 있나요?', a: '{year}년은 ISO 8601 달력에 따라 {weeks}주입니다.' },
      { q: '{year}년 1주차는 언제 시작하나요?', a: '{year}년 1주차는 {w1startFull}에 시작합니다.' },
    ],
  },
  nl: {
    titleTpl: 'Weeknummers {year} – Volledig ISO Weekkalender',
    metaDescTpl: 'Volledige lijst van ISO-weeknummers voor {year}. Alle {weeks} weken met begin- en einddatums. Gratis ISO-kalender.',
    kicker: 'Weekkalender',
    headlineTpl: 'Weeknummers<br><em>{year}</em>',
    subheadTpl: 'Alle {weeks} ISO-weken van {year} — met begin- en einddatum voor elke week.',
    weekLabel: 'Week',
    fromLabel: 'Van (maandag)',
    toLabel: 'Tot (zondag)',
    monthNames: ['Januari','Februari','Maart','April','Mei','Juni','Juli','Augustus','September','Oktober','November','December'],
    dayNames: ['Ma','Di','Wo','Do','Vr','Za','Zo'],
    currentWeekLabel: 'Huidige week',
    totalWeeksLabel: 'Totaal ISO-weken',
    weeksInYear: 'weken',
    seoH2a: 'Wat zijn ISO-weeknummers?',
    seoP1: 'ISO 8601-weeknummers zijn een gestandaardiseerd systeem om weken binnen een kalenderjaar te nummeren van 1 tot 52 (of 53). Elke week begint op maandag, en week 1 is de week die de eerste donderdag van het jaar bevat.',
    seoH2b: 'Weeknummers gebruiken in {year}',
    seoP2Tpl: 'Gebruik deze weekkalender voor projectplanning, het controleren van deadlines, het berekenen van fiscale kwartalen of in elke situatie waarbij genummerde weken nodig zijn.',
    faqTitle: 'Veelgestelde vragen',
    source: null,
    faqsTpl: [
      { q: 'Hoeveel weken heeft {year}?', a: '{year} heeft {weeks} weken volgens de ISO 8601-kalender.' },
      { q: 'Wanneer begint week 1 van {year}?', a: 'Week 1 van {year} begint op {w1startFull}.' },
    ],
  },
};
