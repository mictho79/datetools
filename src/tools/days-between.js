...
module.exports = {
  pages: [
    { id: 'days-between-dates', slugs: { en: 'days-between-dates', fr: 'fr/jours-entre-deux-dates', es: 'es/dias-entre-fechas', pt: 'pt/dias-entre-datas', de: 'de/tage-zwischen-datumen', it: 'it/giorni-tra-date', pl: 'pl/dni-miedzy-datami' } },
  ],
