...
const T = {
  ...
  ja: {
    title: '日付計算ツール – 日付に日数を加算・減算 | DateCalc.app',
    metaDesc: '任意の日付に日数・週数・月数・年数を加算または減算します。X日後の日付を確認できる無料オンライン日付計算ツール。',
    kicker: '日付計算ツール',
    headline: 'その<em>日付</em>は<br>いつですか？',
    subhead: '任意の開始日から日数・週数・月数・年数を加算または減算します。',
    dateLabel: '開始日',
    opLabel: '演算',
    add: '加算', sub: '減算',
    unitDays: '日', unitWeeks: '週', unitMonths: 'ヶ月', unitYears: '年',
    calcBtn: '→ 計算する',
    tipText: '"時間は一方向に流れるが、好奇心は前にも後ろにも向けることができる。"',
    examples: ['今日 + 100日', '今日 − 90日', '今日 + 1年'],
    resultsHeader: '計算結果の日付',
    weekdayLbl: '曜日', dayOfYearLbl: '年間通算日', weekNumLbl: '週番号', leapLbl: '閏年',
    yes: 'はい', no: 'いいえ',
    errInvalid: '→ 無効な日付です。入力を確認してください。',
    errAmount: '→ 有効な数値を入力してください。',
    seoH2a: '日付に日数を加算するには？',
    seoP1: '日付に日数を加算するのは簡単に見えますが、月の境目で複雑になります。1月15日に30日を加えると、通常の年では2月14日になります。1月31日に30日を加えると3月2日（閏年は3月1日）になります。この計算ツールは月の長さの違い、年の変わり目、閏年の2月の追加日を含むすべての境界ケースを自動で処理します。',
    seoH2b: '日付計算の実用的な使用例',
    seoP2: '日付計算はビジネスと個人生活で常に使われます。企業は支払期日（ネット30日、ネット60日）、サブスクリプションの更新日、試用期間の終了日、保証期限を計算します。医療スタッフは投薬スケジュール、妊娠段階、フォローアップ診察の期間を追跡します。法務チームは法定期限を計算します。プロジェクトマネージャーはスプリント期間を開始日に加えてマイルストーン日程を設定します。',
    faqTitle: 'よくある質問',
    source: { url: 'https://www.iso.org/iso-8601-date-and-time-format.html', label: 'ISO 8601 – 日付と時刻のフォーマット' },
    faqs: [
      { q: '30日後の日付は何日ですか？', a: '今日を開始日として入力し、「加算」と「30日」を選択してから「計算する」をクリックしてください。結果は30日後の正確な日付になります。例えば3月15日の30日後は4月14日です。' },
      { q: '90日後の日付は何日ですか？', a: '同じ方法で90日を使用してください。月の長さが異なるため、90日は正確に3ヶ月とは一致しません。' },
      { q: '特定の日付に30日を加算するには？', a: '対象の日付を開始日として入力し、「加算」を選択し、数量フィールドに30を入力して「日」を単位として選び「計算する」をクリックしてください。' },
      { q: '日付から月数を引くには？', a: '演算メニューから「減算」を選択し、月数を入力して「月」を単位として選択します。計算ツールは3月31日から1ヶ月引くと2月28日（閏年は29日）になる境界ケースも正しく処理します。' },
      { q: 'プロジェクトの期日を計算するには？', a: 'プロジェクトの開始日を入力し、「加算」を選択して、プロジェクト期間を入力し、適切な単位を選択してください。結果には曜日とともに期日が表示されます。' },
      { q: '100日後の日付は何日ですか？', a: '1月1日から100日後は通常の年では4月11日です。' },
      { q: '6ヶ月後の日付は何日ですか？', a: '今日を開始日として入力し、「加算」と「6ヶ月」を選択してください。結果は8月31日に6ヶ月を加えるなどの境界ケースも正しく処理します。' },
      { q: '閏年は考慮されますか？', a: 'はい。計算ツールは日付の計算において閏年を自動的に考慮します。' },
    ],
    weekDays: ['日曜日','月曜日','火曜日','水曜日','木曜日','金曜日','土曜日'],
  },
  ko: {
    title: '날짜 계산기 – 날짜에 일수 더하기/빼기 | DateCalc.app',
    metaDesc: '임의의 날짜에 일수, 주수, 월수, 년수를 더하거나 뺍니다. X일 후의 날짜를 확인하는 무료 온라인 날짜 계산기.',
    kicker: '날짜 계산기',
    headline: '그 <em>날짜</em>는<br>언제인가요?',
    subhead: '임의의 시작 날짜에서 일수, 주수, 월수, 년수를 더하거나 빼세요.',
    dateLabel: '시작 날짜',
    opLabel: '연산',
    add: '더하기', sub: '빼기',
    unitDays: '일', unitWeeks: '주', unitMonths: '개월', unitYears: '년',
    calcBtn: '→ 계산하기',
    tipText: '"시간은 한 방향으로 흐르지만, 호기심은 앞뒤를 모두 볼 수 있게 해준다."',
    examples: ['오늘 + 100일', '오늘 − 90일', '오늘 + 1년'],
    resultsHeader: '계산 결과 날짜',
    weekdayLbl: '요일', dayOfYearLbl: '연간 통산 일수', weekNumLbl: '주 번호', leapLbl: '윤년',
    yes: '예', no: '아니요',
    errInvalid: '→ 유효하지 않은 날짜입니다. 입력을 확인하세요.',
    errAmount: '→ 유효한 수량을 입력하세요.',
    seoH2a: '날짜에 일수를 더하려면?',
    seoP1: '날짜에 일수를 더하는 것은 간단해 보이지만 월 경계에서 복잡해집니다. 1월 15일에 30일을 더하면 일반 년에는 2월 14일이 됩니다. 1월 31일에 30일을 더하면 3월 2일(윤년은 3월 1일)이 됩니다. 이 계산기는 월 길이 차이, 연도 변화, 윤년의 2월 추가일을 포함한 모든 경계 케이스를 자동으로 처리합니다.',
    seoH2b: '날짜 계산의 실용적인 활용 사례',
    seoP2: '날짜 계산은 비즈니스와 개인 생활에서 항상 사용됩니다. 기업은 지불 기한(넷 30일, 넷 60일), 구독 갱신일, 체험 기간 종료일, 보증 만료일을 계산합니다. 의료 인력은 복약 일정, 태아 단계, 추적 진료 기간을 추적합니다. 법무팀은 법적 기한을 계산합니다.',
    faqTitle: '자주 묻는 질문',
    source: { url: 'https://www.iso.org/iso-8601-date-and-time-format.html', label: 'ISO 8601 – 날짜 및 시간 형식' },
    faqs: [
      { q: '30일 후의 날짜는 언제인가요?', a: '오늘을 시작 날짜로 입력하고 "더하기"와 "30일"을 선택한 다음 "계산하기"를 클릭하세요. 결과는 30일 후의 정확한 날짜입니다. 예를 들어 3월 15일의 30일 후는 4월 14일입니다.' },
      { q: '90일 후의 날짜는 언제인가요?', a: '같은 방법으로 90일을 사용하세요. 월의 길이가 다르기 때문에 90일은 정확히 3개월과 일치하지 않습니다.' },
      { q: '특정 날짜에 30일을 더하려면?', a: '대상 날짜를 시작 날짜로 입력하고, "더하기"를 선택하고, 수량 필드에 30을 입력하고 "일"을 단위로 선택한 다음 "계산하기"를 클릭하세요.' },
      { q: '날짜에서 월수를 빼려면?', a: '연산 메뉴에서 "빼기"를 선택하고, 월수를 입력한 다음 "개월"을 단위로 선택하세요. 계산기는 3월 31일에서 1개월을 빼면 2월 28일(윤년은 29일)이 되는 경계 케이스도 올바르게 처리합니다.' },
      { q: '프로젝트 마감일을 계산하려면?', a: '프로젝트 시작 날짜를 입력하고 "더하기"를 선택하여 프로젝트 기간을 입력하고 적절한 단위를 선택하세요. 결과에는 요일과 함께 마감일이 표시됩니다.' },
      { q: '100일 후의 날짜는 언제인가요?', a: '1월 1일부터 100일 후는 일반 년에는 4월 11일입니다.' },
      { q: '6개월 후의 날짜는 언제인가요?', a: '오늘을 시작 날짜로 입력하고 "더하기"와 "6개월"을 선택하세요. 결과는 8월 31일에 6개월을 더하는 등의 경계 케이스도 올바르게 처리합니다.' },
      { q: '윤년이 고려되나요?', a: '네. 계산기는 날짜 계산 시 윤년을 자동으로 고려합니다.' },
    ],
    weekDays: ['일요일','월요일','화요일','수요일','목요일','금요일','토요일'],
  },
  nl: {
    title: 'Datumcalculator – Dagen Optellen of Aftrekken | DateCalc.app',
    metaDesc: 'Tel dagen, weken, maanden of jaren op bij of trek ze af van een datum. Controleer welke datum het over X dagen is. Gratis online datumcalculator.',
    kicker: 'Datum Calculator',
    headline: 'Welke <em>datum</em><br>is het dan?',
    subhead: 'Tel dagen, weken, maanden of jaren op bij of trek ze af van een startdatum.',
    dateLabel: 'Startdatum',
    opLabel: 'Bewerking',
    add: 'Optellen', sub: 'Aftrekken',
    unitDays: 'dagen', unitWeeks: 'weken', unitMonths: 'maanden', unitYears: 'jaren',
    calcBtn: '→ BEREKEN',
    tipText: '"De tijd beweegt in één richting, maar nieuwsgierigheid laat ons voor- en achteruit kijken."',
    examples: ['Vandaag + 100 dagen', 'Vandaag − 90 dagen', 'Vandaag + 1 jaar'],
    resultsHeader: 'Resulterende datum',
    weekdayLbl: 'Dag van de week', dayOfYearLbl: 'Dag van het jaar', weekNumLbl: 'Weeknummer', leapLbl: 'Schrikkeljaar',
    yes: 'Ja', no: 'Nee',
    errInvalid: '→ Ongeldige datum. Controleer je invoer.',
    errAmount: '→ Voer een geldig aantal in.',
    seoH2a: 'Hoe tel je dagen op bij een datum?',
    seoP1: 'Dagen optellen bij een datum lijkt eenvoudig, maar maandgrenzen maken het ingewikkelder. Als je 30 dagen optelt bij 15 januari, kom je uit op 14 februari in een gewoon jaar. Voeg 30 dagen toe aan 31 januari en je komt uit op 2 maart (of 1 maart in een schrikkeljaar). Deze calculator verwerkt automatisch al deze randgevallen, inclusief maandlengteverschillen, jaarwisselingen en de extra dag in februari in schrikkeljaren.',
    seoH2b: 'Praktische toepassingen van datumaritmetiek',
    seoP2: 'Datumaritmetiek wordt voortdurend gebruikt in het zakelijke en persoonlijke leven. Bedrijven berekenen vervaldatums (netto-30, netto-60 voorwaarden), verlengingsdatums van abonnementen, einddatums van proefperiodes en vervaldatums van garanties. Medisch personeel houdt medicatieschema\'s, prenatale stadia en controlebezoekvensters bij. Juridische teams berekenen wettelijke deadlines.',
    faqTitle: 'Veelgestelde vragen',
    source: { url: 'https://www.iso.org/iso-8601-date-and-time-format.html', label: 'ISO 8601 – Datum- en tijdformaat' },
    faqs: [
      { q: 'Welke datum is het over 30 dagen?', a: 'Voer de datum van vandaag in als startdatum, selecteer "Optellen" en "30 dagen", klik dan op Berekenen. Het resultaat is de exacte datum over 30 dagen. Bijvoorbeeld: 30 dagen na 15 maart is 14 april.' },
      { q: 'Welke datum is het over 90 dagen?', a: 'Gebruik dezelfde methode met 90 dagen. Omdat maanden een verschillende lengte hebben, komt 90 dagen niet exact overeen met 3 maanden.' },
      { q: 'Hoe tel ik 30 dagen op bij een specifieke datum?', a: 'Voer de doeldatum in als startdatum, selecteer "Optellen" en typ 30 in het veld voor de hoeveelheid met "dagen" als eenheid, klik dan op Berekenen.' },
      { q: 'Hoe trek ik maanden af van een datum?', a: 'Selecteer "Aftrekken" uit het bewerkingsmenu, typ het aantal maanden in en selecteer "maanden" als eenheid. De calculator verwerkt randgevallen correct, zoals het aftrekken van 1 maand van 31 maart, wat correct 28 februari geeft (of 29 in een schrikkeljaar).' },
      { q: 'Hoe bereken ik een projectdeadline?', a: 'Voer de startdatum van het project in, selecteer "Optellen", voer de projectduur in en selecteer de juiste eenheid. Het resultaat toont de deadlinedatum inclusief dag van de week.' },
      { q: 'Welke datum is het over 100 dagen?', a: '100 dagen na 1 januari valt op 11 april in een gewoon jaar.' },
      { q: 'Welke datum is het over 6 maanden?', a: 'Voer vandaag in als startdatum, selecteer "Optellen" en "6 maanden". Het resultaat verwerkt randgevallen correct zoals het optellen van 6 maanden bij 31 augustus.' },
      { q: 'Worden schrikkeljaren meegenomen?', a: 'Ja. De calculator houdt automatisch rekening met schrikkeljaren bij het berekenen van datums.' },
    ],
...
module.exports = {
  pages: [
    { id: 'date-calculator', slugs: { en: 'date-calculator', fr: 'fr/calculateur-date', es: 'es/calculadora-fechas', pt: 'pt/calculadora-de-data', de: 'de/datumsrechner', it: 'it/calcolatore-data', pl: 'pl/kalkulator-daty', ja: 'ja/hidzuke-keisanki', ko: 'ko/nal-jja-gyesan-gi', nl: 'nl/datum-calculator' } },
  ],
