...
const T = {
  ...
  ja: {
    title: '今日は何曜日？ – 任意の日付の曜日 | DateCalc.app',
    metaDesc: '今日が何曜日かを確認、または任意の日付の曜日を検索できます。年間通算日、週番号、残り日数も表示します。',
    kicker: '今日は何曜日？',
    headline: '今日は<em>何曜日</em><br>ですか？',
    subhead: '今日の曜日を即座に確認、または任意の日付の曜日を検索できます。',
    dateLabel: '日付（空白の場合は今日）',
    calcBtn: '→ 日付を確認',
    tipText: '"月曜日は心の状態です。でも少なくとも今、何曜日かはわかります。"',
    resultsHeader: '日付情報',
    dayLbl: '曜日', dateLbl: '完全な日付',
    doyLbl: '年間通算日', weekNumLbl: '週番号',
    doyLeftLbl: '年間残り日数', leapLbl: '閏年',
    yes: 'はい', no: 'いいえ',
    errInvalid: '→ 無効な日付です。入力を確認してください。',
    seoH2a: 'ある日付は何曜日ですか？',
    seoP1: '任意の日付の曜日を求めるために、数学者はいくつかの優れたアルゴリズムを開発しました。ツェラーの公式は剰余算術を使って日・月・年の値から直接曜日を計算します。数学者ジョン・コンウェイが発明したドゥームズデイ・アルゴリズムは、同じ年の特定の覚えやすい日付（4/4、6/6、8/8、10/10、12/12など）が常に同じ曜日に当たるという事実を利用します。日常使用には、この計算ツールがすべてを自動で行います。1900年〜2100年の任意の日付を入力するだけで、即座に曜日がわかります。',
    seoH2b: '各月は何日ありますか？',
    seoP2: '1月、3月、5月、7月、8月、10月、12月は31日あります。4月、6月、9月、11月は30日あります。2月は通常の年に28日、閏年に29日あります。4で割り切れる年は閏年ですが、100で割り切れる年（世紀年）は除きます。ただし400で割り切れる年は閏年です。したがって2000年は閏年でしたが、1900年はそうではありませんでした。',
    faqTitle: 'よくある質問',
    source: { url: 'https://en.wikipedia.org/wiki/Gregorian_calendar', label: 'Wikipedia – グレゴリオ暦' },
    faqs: [
      { q: '今日は何曜日ですか？', a: 'このページを開くと自動的に今日の曜日が表示されます。表示される日付はあなたのローカルタイムゾーンに基づいています。入力は不要です。' },
      { q: '2000年1月1日は何曜日でしたか？', a: '2000年1月1日は土曜日でした。新しいミレニアムの最初の日でもありました。上の日付フィールドに01/01/2000と入力して確認できます。' },
      { q: '私は何曜日に生まれましたか？', a: '上のフィールドに誕生日を入力すると、生まれた曜日がわかります。次の誕生日が何曜日かも確認できます。' },
      { q: '100日後は何曜日ですか？', a: 'この計算には、日付に日数を加算できる日付計算ツールをご利用ください。' },
      { q: 'ドゥームズデイ・アルゴリズムとは何ですか？', a: 'ドゥームズデイ・アルゴリズムはジョン・コンウェイが発明した暗算法で、任意の日付の曜日を頭の中で計算できます。2026年のドゥームズデイは月曜日です。' },
      { q: '2026年のクリスマスは何曜日ですか？', a: '2026年のクリスマス（2026年12月25日）は金曜日です。上に25/12/2026と入力して確認できます。' },
      { q: '過去の日付は何曜日でしたか？', a: '上の日付フィールドに1900年1月1日〜2100年12月31日の任意の過去日付を入力してください。' },
      { q: '次の誕生日は何曜日ですか？', a: '日付フィールドに次の誕生日を入力してください。例えば誕生日が6月15日なら、15/06/2026と入力して月曜日であることがわかります。' },
    ],
    weekDays: ['日曜日','月曜日','火曜日','水曜日','木曜日','金曜日','土曜日'],
    months: ['1月','2月','3月','4月','5月','6月','7月','8月','9月','10月','11月','12月'],
  },
  ko: {
    title: '오늘은 무슨 요일? – 임의 날짜의 요일 | DateCalc.app',
    metaDesc: '오늘이 무슨 요일인지 확인하거나 임의의 날짜의 요일을 검색하세요. 연간 통산 일수, 주 번호, 남은 일수도 표시합니다.',
    kicker: '오늘은 무슨 요일?',
    headline: '오늘은 <em>무슨 요일</em><br>인가요?',
    subhead: '오늘의 요일을 즉시 확인하거나 임의의 날짜의 요일을 검색하세요.',
    dateLabel: '날짜 (비워두면 오늘)',
    calcBtn: '→ 날짜 확인',
    tipText: '"월요일은 마음의 상태입니다. 하지만 적어도 이제 무슨 요일인지는 알 수 있습니다."',
    resultsHeader: '날짜 정보',
    dayLbl: '요일', dateLbl: '전체 날짜',
    doyLbl: '연간 통산 일수', weekNumLbl: '주 번호',
    doyLeftLbl: '연간 남은 일수', leapLbl: '윤년',
    yes: '예', no: '아니요',
    errInvalid: '→ 유효하지 않은 날짜입니다. 입력을 확인하세요.',
    seoH2a: '어떤 날짜는 무슨 요일인가요?',
    seoP1: '임의의 날짜의 요일을 구하기 위해 수학자들은 몇 가지 우아한 알고리즘을 개발했습니다. 젤러의 합동식은 모듈러 산술을 사용하여 일, 월, 연도 값에서 직접 요일을 계산합니다. 수학자 존 콘웨이가 발명한 둠스데이 알고리즘은 같은 해의 특정 기억하기 쉬운 날짜들(4/4, 6/6, 8/8, 10/10, 12/12 등)이 항상 같은 요일에 해당한다는 사실을 활용합니다. 이 계산기는 이 모든 것을 자동으로 처리합니다.',
    seoH2b: '각 달은 며칠인가요?',
    seoP2: '1월, 3월, 5월, 7월, 8월, 10월, 12월은 31일입니다. 4월, 6월, 9월, 11월은 30일입니다. 2월은 일반 년에 28일, 윤년에 29일입니다. 4로 나누어 떨어지는 해는 윤년이지만, 100으로 나누어 떨어지는 해(세기년)는 제외합니다. 단, 400으로 나누어 떨어지는 해는 윤년입니다.',
    faqTitle: '자주 묻는 질문',
    source: { url: 'https://en.wikipedia.org/wiki/Gregorian_calendar', label: 'Wikipedia – 그레고리력' },
    faqs: [
      { q: '오늘은 무슨 요일인가요?', a: '이 페이지를 열면 자동으로 오늘의 요일이 표시됩니다. 표시되는 날짜는 로컬 시간대를 기반으로 합니다. 입력이 필요 없습니다.' },
      { q: '2000년 1월 1일은 무슨 요일이었나요?', a: '2000년 1월 1일은 토요일이었습니다. 새 밀레니엄의 첫 날이기도 했습니다. 위의 날짜 필드에 01/01/2000을 입력하여 확인할 수 있습니다.' },
      { q: '나는 무슨 요일에 태어났나요?', a: '위의 필드에 생일을 입력하면 태어난 요일을 알 수 있습니다. 다음 생일이 무슨 요일인지도 확인할 수 있습니다.' },
      { q: '100일 후는 무슨 요일인가요?', a: '이 계산에는 날짜에 일수를 더할 수 있는 날짜 계산기를 사용하세요.' },
      { q: '둠스데이 알고리즘이란 무엇인가요?', a: '둠스데이 알고리즘은 존 콘웨이가 발명한 암산법으로, 임의의 날짜의 요일을 머릿속에서 계산할 수 있게 해줍니다. 2026년의 둠스데이는 월요일입니다.' },
      { q: '2026년 크리스마스는 무슨 요일인가요?', a: '2026년 크리스마스(2026년 12월 25일)는 금요일입니다. 위에 25/12/2026을 입력하여 확인할 수 있습니다.' },
      { q: '과거 날짜는 무슨 요일이었나요?', a: '위의 날짜 필드에 1900년 1월 1일부터 2100년 12월 31일 사이의 임의의 과거 날짜를 입력하세요.' },
      { q: '다음 생일은 무슨 요일인가요?', a: '날짜 필드에 다음 생일을 입력하세요. 예를 들어 생일이 6월 15일이라면 15/06/2026을 입력하여 월요일임을 확인할 수 있습니다.' },
    ],
    weekDays: ['일요일','월요일','화요일','수요일','목요일','금요일','토요일'],
    months: ['1월','2월','3월','4월','5월','6월','7월','8월','9월','10월','11월','12월'],
  },
  nl: {
    title: 'Welke Dag Is Het Vandaag? – Dag van de Week voor Elke Datum | DateCalc.app',
    metaDesc: 'Controleer welke dag het vandaag is, of vind de dag van de week voor een willekeurige datum. Toont dagnummer, weeknummer en resterende dagen.',
    kicker: 'Welke dag is het vandaag?',
    headline: 'Welke <em>dag</em><br>is het vandaag?',
    subhead: 'Bekijk direct de dag van vandaag of zoek de dag van de week voor een willekeurige datum.',
    dateLabel: 'Datum (leeg laten voor vandaag)',
    calcBtn: '→ Controleer datum',
    tipText: '"Maandag is een gemoedstoestand. Maar tenminste weet je nu in welke je zit."',
    resultsHeader: 'Datuminformatie',
    dayLbl: 'Dag van de week', dateLbl: 'Volledige datum',
    doyLbl: 'Dag van het jaar', weekNumLbl: 'Weeknummer',
    doyLeftLbl: 'Resterende dagen in het jaar', leapLbl: 'Schrikkeljaar',
    yes: 'Ja', no: 'Nee',
    errInvalid: '→ Ongeldige datum. Controleer je invoer.',
    seoH2a: 'Op welke dag van de week valt een datum?',
    seoP1: 'Om de dag van de week voor een willekeurige datum te vinden, hebben wiskundigen verschillende elegante algoritmen ontwikkeld. De congruentie van Zeller gebruikt modulaire rekenkunde om de dag direct te berekenen uit de dag-, maand- en jaarwaarden. Het Doomsday-algoritme, uitgevonden door wiskundige John Conway, maakt gebruik van het feit dat bepaalde gedenkwaardige datums (4/4, 6/6, 8/8, 10/10, 12/12 en andere) altijd op dezelfde dag van de week vallen in een bepaald jaar.',
    seoH2b: 'Hoeveel dagen heeft elke maand?',
    seoP2: 'Januari, maart, mei, juli, augustus, oktober en december hebben 31 dagen. April, juni, september en november hebben 30 dagen. Februari heeft 28 dagen in een gewoon jaar en 29 dagen in een schrikkeljaar. Een schrikkeljaar is elk jaar deelbaar door 4, met uitzondering van eeuwjaren (deelbaar door 100), die ook deelbaar moeten zijn door 400. Dus 2000 was een schrikkeljaar, maar 1900 niet.',
    faqTitle: 'Veelgestelde vragen',
    source: { url: 'https://en.wikipedia.org/wiki/Gregorian_calendar', label: 'Wikipedia – Gregoriaanse kalender' },
    faqs: [
      { q: 'Welke dag is het vandaag?', a: 'Open deze pagina om automatisch de dag van vandaag te zien. De weergegeven datum is gebaseerd op jouw lokale tijdzone. Er is geen invoer nodig.' },
      { q: 'Op welke dag viel 1 januari 2000?', a: '1 januari 2000 was een zaterdag. Het was ook de eerste dag van het nieuwe millennium. Je kunt dit controleren door 01/01/2000 in te voeren in het datumveld hierboven.' },
      { q: 'Op welke dag van de week ben ik geboren?', a: 'Voer je geboortedatum in het veld hierboven in en de calculator vertelt je op welke dag van de week je geboren bent. Je kunt ook controleren op welke dag je volgende verjaardag valt.' },
      { q: 'Op welke dag is het over 100 dagen?', a: 'Gebruik onze Datumcalculator voor deze berekening, waarmee je dagen kunt optellen bij een datum.' },
      { q: 'Wat is het Doomsday-algoritme?', a: 'Het Doomsday-algoritme is een rekenmethode in het hoofd uitgevonden door John Conway, waarmee je de dag van de week voor een willekeurige datum in je hoofd kunt berekenen. Voor 2026 is de Doomsday-dag maandag.' },
      { q: 'Op welke dag valt Kerstmis in 2026?', a: 'Kerstmis 2026 (25 december 2026) valt op een vrijdag. Voer 25/12/2026 in hierboven om te bevestigen.' },
      { q: 'Op welke dag viel een datum in het verleden?', a: 'Voer een willekeurige historische datum tussen 1 januari 1900 en 31 december 2100 in het datumveld hierboven in.' },
      { q: 'Op welke dag van de week valt mijn volgende verjaardag?', a: 'Voer je aankomende verjaardag in het datumveld in. Als je verjaardag bijvoorbeeld 15 juni is, voer dan 15/06/2026 in om te zien dat het een maandag is.' },
    ],
...
module.exports = {
  pages: [
    { id: 'what-day-is-it-today', slugs: { en: 'what-day-is-it-today', fr: 'fr/quel-jour-sommes-nous', es: 'es/que-dia-es-hoy', pt: 'pt/que-dia-e-hoje', de: 'de/welcher-tag-ist-heute', it: 'it/che-giorno-e-oggi', pl: 'pl/jaki-dzis-dzien', ja: 'ja/kyou-wa-nannichi', ko: 'ko/oneul-museun-yoil', nl: 'nl/welke-dag-is-het' } },
  ],
