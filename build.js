...
${JSON.stringify({
  ...
  const orgSchema = `
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"Organization","name":"DateCalc.app","url":"https://datecalc.app","logo":"https://datecalc.app/og.png","contactPoint":{"@type":"ContactPoint","email":"contact@datecalc.app","contactType":"customer support"}}
</script>`;
...
const PRIVACY_CONTENT = {
  en: {
    ...
    sections: [
      ...
      { h: 'Contact', p: 'For privacy questions, consent withdrawal, or any right you want to exercise, email <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. We read every message and typically reply within a few business days. For Google-specific data requests (what AdSense stores, deletion of your ad profile), use Google\'s own channels linked above — we cannot modify their records on your behalf.' },
    ],
  },
  fr: {
  ...
  pt: {
    ...
    sections: [
      ...
      { h: 'Contato', p: 'Para dúvidas de privacidade, retirada de consentimento ou exercício de qualquer direito, escreva para <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. Lemos cada mensagem e normalmente respondemos em poucos dias úteis. Para solicitações específicas do Google (o que o AdSense armazena, exclusão do seu perfil publicitário), use os canais do próprio Google linkados acima — não podemos modificar os registros deles em seu nome.' },
    ],
  },
  de: {
    ...
    sections: [
      ...
      { h: 'Kontakt', p: 'Für Datenschutzfragen, Widerruf der Einwilligung oder Ausübung eines Rechts schreibe an <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. Wir lesen jede Nachricht und antworten in der Regel innerhalb weniger Werktage. Für Google-spezifische Anfragen (was AdSense speichert, Löschung deines Werbeprofils) nutze Googles eigene Kanäle oben — wir können ihre Aufzeichnungen nicht in deinem Namen ändern.' },
    ],
  },
  it: {
  ...
  pl: {
    ...
    sections: [
      ...
      { h: 'Kontakt', p: 'W sprawach prywatności, wycofania zgody lub skorzystania z dowolnego prawa napisz na <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. Czytamy każdą wiadomość i zwykle odpowiadamy w ciągu kilku dni roboczych. W przypadku zapytań dotyczących Google (co przechowuje AdSense, usunięcie profilu reklamowego) korzystaj z kanałów Google linkowanych wyżej — nie możemy zmieniać ich rekordów w Twoim imieniu.' },
    ],
  },
  ja: {
    ...
    sections: [
      ...
      { h: 'お問い合わせ', p: 'プライバシーに関するご質問、同意の撤回、権利の行使は <a href="mailto:contact@datecalc.app">contact@datecalc.app</a> までお送りください。すべてのメッセージを読み、通常は数営業日以内にご返信します。Google特有のデータ要求（AdSenseが保存する内容、広告プロファイルの削除など）については、上記リンクのGoogle独自の窓口をご利用ください — 当方から彼らの記録を変更することはできません。' },
    ],
  },
  ko: {
    ...
    sections: [
      ...
      { h: '문의', p: '개인정보 관련 문의, 동의 철회, 어떤 권리 행사든 <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>로 연락 주십시오. 모든 메시지를 읽으며 보통 며칠 내에 답변 드립니다. Google 관련 요청(AdSense가 저장하는 내용, 광고 프로필 삭제)은 위 링크된 Google 자체 창구를 이용하십시오 — 저희가 그들의 기록을 사용자 대신 수정할 수는 없습니다.' },
    ],
  },
  nl: {
    ...
    sections: [
      ...
      { h: 'Contact', p: 'Voor privacyvragen, het intrekken van toestemming of het uitoefenen van een recht kun je mailen naar <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. We lezen elke boodschap en antwoorden meestal binnen een paar werkdagen. Voor Google-specifieke verzoeken (wat AdSense opslaat, verwijdering van je advertentieprofiel) gebruik je de Google-kanalen hierboven — wij kunnen hun registraties niet namens jou aanpassen.' },
    ],
  },
};
...
const ABOUT_CONTENT = {
  en: {
    ...
    sections: [
      ...
      { h: 'Contact', p: 'Feedback, bug reports, feature requests, or just hi — <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. We read every message. Business inquiries (ads, partnerships, licensing): same address, mark the subject "Business".' },
    ],
  },
  fr: {
    ...
    sections: [
      ...
      { h: 'Contact', p: 'Retours, bugs, idées ou juste un bonjour — <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. On lit chaque message. Pour les demandes professionnelles (publicité, partenariats, licences) : même adresse, sujet « Business ».' },
    ],
  },
  es: {
    ...
    sections: [
      { h: 'Qué ofrecemos', p: 'Calculadoras de edad (incluidas las de bebé, perro y gato), días entre fechas, días hábiles, cuentas regresivas para las grandes fiestas, números de semana ISO, conversión de zonas horarias y hubs año por año de nacimientos. Todo gratis, sin registro, y pensado para resolver el cálculo concreto que necesitas sin distracciones.' },
      ...
      { h: 'Cómo lo pagamos', p: 'DateCalc.app se financia con Google AdSense. A nosotros tampoco nos encantan los anuncios, pero son lo que hace realista mantener el sitio gratuito, sin paywalls, sin "pro tier" y sin captura de correos. Los anuncios solo se cargan si haces clic en "Aceptar" en el banner de consentimiento en la UE/Reino Unido; fuera de esas regiones se cargan por defecto pero nunca usan segmentación personalizada sin consentimiento. Consulta la <a href="/es/privacidad/">política de privacidad</a> para el desglose completo.' },
      { h: '¿Quién está detrás?', p: 'DateCalc está construido y mantenido por Mike, un desarrollador con base en Francia que se obsesiona con los casos límite — si las semanas empiezan en domingo o en lunes (spoiler: aquí usamos lunes, ISO 8601), cómo manejar los cumpleaños del 29 de febrero en los años no bisiestos, o cómo encajar las distintas tradiciones hispanas para el Año Nuevo o la Navidad en una sola página clara. Acertar en los detalles es aproximadamente el 80 % del trabajo.' },
      { h: 'Contacto', p: 'Feedback, bugs, sugerencias o simplemente hola — <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. Leemos cada mensaje. Consultas profesionales (publicidad, partnerships, licencias): misma dirección, pon "Business" en el asunto.' },
    ],
  },
  pt: {
    ...
    sections: [
      ...
      { h: 'Contato', p: 'Feedback, bugs, ideias ou só um oi — <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. Lemos cada mensagem. Consultas comerciais (anúncios, parcerias, licenças): mesmo endereço, coloque "Business" no assunto.' },
    ],
  },
  de: {
    ...
    sections: [
      ...
      { h: 'Kontakt', p: 'Feedback, Bugs, Ideen oder einfach Hallo — <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. Wir lesen jede Nachricht. Geschäftliche Anfragen (Werbung, Partnerschaften, Lizenzen): gleiche Adresse, Betreff „Business".' },
    ],
  },
  it: {
    ...
    sections: [
      ...
      { h: 'Contatto', p: 'Feedback, bug, suggerimenti o solo un ciao — <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. Leggiamo ogni messaggio. Richieste business (pubblicità, partnership, licenze): stesso indirizzo, oggetto "Business".' },
    ],
  },
  pl: {
    ...
    sections: [
      ...
      { h: 'Kontakt', p: 'Opinie, błędy, pomysły albo po prostu cześć — <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. Czytamy każdą wiadomość. Zapytania biznesowe (reklamy, partnerstwa, licencje): ten sam adres, w temacie wpisz "Business".' },
    ],
  },
  ja: {
    ...
    sections: [
      ...
      { h: 'お問い合わせ', p: 'フィードバック、バグ報告、機能要望、あるいは単なる挨拶でも — <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>。すべてのメッセージに目を通しています。ビジネスに関するお問い合わせ（広告、パートナーシップ、ライセンス）は同じアドレス宛に件名「Business」とご記入ください。' },
    ],
  },
  ko: {
    ...
    sections: [
      ...
      { h: '문의', p: '피드백, 버그 제보, 기능 요청, 혹은 그냥 안부라도 — <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. 모든 메시지를 읽습니다. 비즈니스 문의(광고, 제휴, 라이선스): 같은 주소, 제목에 "Business"라고 적어 주세요.' },
    ],
  },
  nl: {
    ...
    sections: [
      ...
      { h: 'Contact', p: 'Feedback, bugs, ideeën of gewoon hoi — <a href="mailto:contact@datecalc.app">contact@datecalc.app</a>. We lezen elk bericht. Zakelijke aanvragen (advertenties, partnerships, licenties): zelfde adres, zet "Business" in het onderwerp.' },
    ],
  },
};
...
${JSON.stringify({
  ...
  "email": "contact@datecalc.app",
  "foundingLocation": { "@type": "Place", "address": { "@type": "PostalAddress", "addressCountry": "FR" } },
  "description": "Free date and time calculators: age, days between dates, week numbers, business days, and time-zone conversion.",
